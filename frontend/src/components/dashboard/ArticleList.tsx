  ...
  return (
    ...
    <div className="card w-full bg-base-100 rounded-[6.5px] shadow-custom-shadow mt-10">
      <div className="card-body">
        ...
        <p className="text-[#195ba5] text-[20px] font-[600] font-montserrat">More information can be found at <a href="https://www.wohohiame.org/" className='underline'>wohohiame.org</a>.</p>
